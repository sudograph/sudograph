...
pub fn get_input_info_strategies<GqlFn, GqlFut>(
...
fn get_input_info_strategy<GqlFn, GqlFut>(
    graphql_ast: &'static Document<String>,
    object_types: &'static Vec<ObjectType<String>>,
...
// TODO I think here is where I need to pass in the graphql_mutation function
// TODO should be pretty easy, but basically the consuming test will pass in the ability to do a graphql_mutation or graphql_query
pub fn create_and_retrieve_object<GqlFn, GqlFut>(
    graphql_ast: &'static Document<String>,
    graphql_mutation: &'static GqlFn,
