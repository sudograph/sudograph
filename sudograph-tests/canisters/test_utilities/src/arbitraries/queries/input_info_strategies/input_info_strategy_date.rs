...
pub fn get_input_info_strategy_date(
    ...
    let strategy = any::<u64>().prop_map(move |nanoseconds| {
        let datetime = chrono::Utc.timestamp(((ic_cdk::api::time() + nanoseconds) / 1000 / 1000 / 1000) as i64, 0).to_rfc3339_opts(chrono::SecondsFormat::Millis, true);
